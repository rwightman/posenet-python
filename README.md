...
### Video Guides:
-[Real time Pose Estimation in Video using Posenet using Deep Learning](https://youtu.be/B_9CcxnH2do?list=PLCK5Mm9zwPkEhwu2OOw2CgO5ikoLdR36l). For freezed model conversion in IR model and real-time prediction
